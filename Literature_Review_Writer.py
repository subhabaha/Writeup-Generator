...
def main():
    ...
    st.text("The app has been developed by Dr. Subhabaha Pal. The AI model used is ChatGPT model developed by OpenAI. Please mail to subhabaha@msn.com for suggestions."
