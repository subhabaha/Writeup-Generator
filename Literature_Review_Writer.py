...
def main():
    ...
    st.subheader("The app has been developed by Dr. Subhabaha Pal. The background AI model used is ChatGPT model developed by OpenAI. Please mail to subhabaha@msn.com for suggestions.")
